  ...
  const extractData = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/api/extract-inspection-report",
        formData,
        {
          headers: {
              ...
              {formData ? (
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="field">
                      <label htmlFor="vehicle_gasoline" className="block mb-1">
                        Vehicle Gasoline
                      </label>
                      <Dropdown
                        id="vehicle_gasoline"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="field">
                      ...
                      <Dropdown
                        ...
                        options={yesNoOptions}
                        onChange={(e) => handleInputChange("air_bags", e.value)}
                        className="w-full"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="field">
                      <label htmlFor="fog_buffer_lamps" className="block mb-1">
                        Fog Buffer Lamps
                      </label>
                      <InputText
                        id="fog_buffer_lamps"
                        ...
                        onChange={(e) =>
                          handleInputChange("fog_buffer_lamps", e.target.value)
                        }
                        className="w-full"
                      />
                    </div>
                    <div className="field">
                      <label htmlFor="four_wheel_driver" className="block mb-1">
                        Four Wheel drive
                      </label>
                      <InputText
                        ...
                        onChange={(e) =>
                          handleInputChange("four_wheel_driver", e.target.value)
                        }
                        className="w-full"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="field">
                      <label htmlFor="remote_smart_key" className="block mb-1">
                        Remote Smart Key
                      </label>
                      <InputText
                        id="remote_smart_key"
                        ...
                        onChange={(e) =>
                          handleInputChange("remote_smart_key", e.target.value)
                        }
                        className="w-full"
                      />
                    </div>
