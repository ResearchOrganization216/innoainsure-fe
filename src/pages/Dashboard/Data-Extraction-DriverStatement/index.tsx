  ...
  const extractData = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5009/api/extract-driver-statement",
        formData,
        {
          headers: {
  ...
  const header = (
    <div className="bg-gradient-to-r to-indigo-900 from-indigo-700 p-6 text-white">
      <h2 className="text-2xl font-bold mb-2">
        Data Extraction for Driver Statement
      </h2>
      <p className="text-blue-100 opacity-80">
        Upload an image of the driver statement to extract data
      </p>
    </div>
  );
